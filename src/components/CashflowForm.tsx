              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  {formData.calls && !isNaN(parseFloat(formData.calls)) 
                    ? `$${(parseFloat(formData.calls) / 1000000).toFixed(1)}M`
                    : 'Amount called from LPs'
                  }
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  {formData.distributions && !isNaN(parseFloat(formData.distributions)) 
                    ? `$${(parseFloat(formData.distributions) / 1000000).toFixed(1)}M`
                    : 'Amount distributed to LPs'
                  }
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  {formData.nav && !isNaN(parseFloat(formData.nav)) 
                    ? `$${(parseFloat(formData.nav) / 1000000).toFixed(1)}M`
                    : 'Current fund NAV'
                  }
                </p>
              </div>
